...
cc_list <- c("dheeraj.tommandru@mssm.edu", "chand.mansuri@mssm.edu", "laith.alazzam@mssm.edu")
send_list <- c("Mark.Liu@mountsinai.org", "Nina.Hart@mountsinai.org", "Richmond.Aririguzoh@mountsinai.org", "Manisha.Drepaul@mountsinai.org", "Dylan.Ferrari@mountsinai.org")
