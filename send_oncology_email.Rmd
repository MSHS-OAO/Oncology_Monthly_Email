...
cc_list <- c("dheeraj.tommandru@mssm.edu", "gregory.lenane@mssm.edu", "laith.alazzam@mssm.edu")
send_list <- c("Mark.Liu@mountsinai.org", "Nina.Hart@mountsinai.org", "Richmond.Aririguzoh@mountsinai.org", "Manisha.Drepaul@mountsinai.org", "Dylan.Ferrari@mountsinai.org", "Shreya.Modi@mountsinai.org")
