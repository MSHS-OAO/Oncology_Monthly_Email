...
cc_list <- c("dheeraj.tommandru@mssm.edu", "chand.mansuri@mssm.edu", "roya.aghaeifar@mssm.edu", "laith.alazzam@mssm.edu")
send_list <- c("Mark.Liu@mountsinai.org", "Nina.Hart@mountsinai.org")
